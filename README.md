...
Платформа для блогов. Доработал проект на Django, - добавил недостающие модели, и написал REST API (DRF) с нуля в соответствие с документацией в формате Redoc. Разработал систему аутентификации используя JWT-токены при помощи библиотеки Djoser. 
